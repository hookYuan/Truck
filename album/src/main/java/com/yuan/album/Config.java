...
public class Config {
    ...
    /**********请求基础配置************/
    public static String NUM = "IMAGENUM";//启动图库时，需要获取图片的数量key值,参数类型为int
    public static String CAMERA = "ISCAMERA"; //是否启动相机key值,参数类型为boolean
    public static String CROP = "ISCROP"; //是否启动剪裁key值，参数类型为boolean
    public static String CROPW = "CROPW"; //剪裁宽度key值，参数类型为int
    public static String CROPH = "CROPH"; //剪裁高度key值，参数类型为int
